...
void function () {
  var badRequireError, canonicalise, CoffeeScript, esprima, estraverse, fs, md5, path, relativeResolve, typescript;
  fs = require('fs');
  ...
  module.exports = function (entryPoint, root, options) {
    ...
    handlers = {
      '.ts': function (typed, canonicalName) {
        return esprima.parse(typescript.transpile(typed));
      },
      '.coffee': function (coffee, canonicalName) {
        return CoffeeScript.transpile(coffee);
      },
